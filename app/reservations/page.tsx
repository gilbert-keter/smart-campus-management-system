...
export const metadata: Metadata = {
  title: "Documentation - Compliance Is Us",
  description: "Explore our comprehensive documentation to understand how Compliance Is Us can streamline your compliance processes. Find guides, tutorials, and support materials here.",
  // other metadata
};
