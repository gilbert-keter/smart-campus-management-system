        ...
        <div className=" w-full mt-16 grid grid-cols-1 gap-8 border-t border-gray-200 pt-16 md:grid-cols-4 lg:grid-cols-6 dark:border-black">
          <div className="text-left sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                <a
                  className="text-black transition hover:text-black/75 dark:text-white dark:hover:text-white/75"
                  href="#"
                >
                  Our Mission
                </a>
          ...
          <div className="text-left sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="flex items-center justify-start gap-1.5" href="#">
                  <span className="text-black transition group-hover:text-black/75 dark:text-white dark:group-hover:text-white/75">
                    Live Chat
                  </span>
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <input
                    id="email"
                    className="w-full rounded-full border-black bg-white px-6 py-3 shadow-sm dark:border-black dark:bg-black dark:text-white"
                    type="email"
                  ...
                  <button
                    className="block rounded-full bg-primary px-8 py-3 font-medium text-white transition hover:bg-indigo-600"
                    type="submit"
                  >
                    Subscribe
                  </button>
